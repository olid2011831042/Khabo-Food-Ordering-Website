...
<body class="fix-header">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/khabo.jpeg" alt="homepage" class="dark-logo" style="width: 35px; height: 30px;" /></span>
                ...
                <div class="navbar-collapse">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/khabo.jpeg" alt="user" class="profile-pic" /></a>
        ...
        <div style="padding-top: 10px;">
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> <a href="https://www.facebook.com/ratul.bhattacharje/">Ratul,Mahin and Olid</a> is the sole owner. This is our junior designing project.</marquee>
            </div>
